    ...
    <AnimatePresence>
      {visible && (
        <motion.nav
          ...
          className={`fixed top-1/2 -translate-y-1/2 ${isRTL ? "left-6" : "right-6"} z-50 hidden xl:flex flex-col gap-1 rounded-xl bg-[#0a1628]/80 border border-amber-500/15 backdrop-blur-md p-3 shadow-lg shadow-black/20`}
        >
