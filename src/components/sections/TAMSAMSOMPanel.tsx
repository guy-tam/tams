...
function CustomTooltip({
  ...
  return (
    <div className="rounded-xl border border-amber-200/40 bg-card/95 backdrop-blur-md p-4 shadow-xl max-w-xs">
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        {/* גרף */}
        <div className="rounded-2xl border border-amber-200/40 bg-white backdrop-blur-md p-6">
          <div className="h-72">
        ...
        <div className="space-y-4">
          {marketData.map((item, i) => (
            <motion.div
              ...
              className="rounded-xl border border-amber-200/40 bg-white backdrop-blur-md p-4 hover:border-amber-400/40 transition-colors"
            >
