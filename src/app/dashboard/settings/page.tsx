  ...
  return (
    <div className="min-h-screen p-4 md:p-8 max-w-4xl space-y-6">
      ...
      >
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between rounded-xl border border-white/[0.06] bg-white/[0.03] p-4">
              ...
              <select
                ...
                className="bg-white/[0.04] border border-amber-500/15 rounded-lg px-3 py-1.5 text-sm text-foreground outline-none focus:border-blue-500/30 focus:ring-1 focus:ring-blue-500/20"
              >
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="rounded-xl border border-white/[0.06] bg-white/[0.03] p-4">
              ...
              <button className="text-xs px-3 py-1.5 rounded-lg border border-amber-500/15 text-blue-300/60 hover:text-blue-200 transition-colors">
                עדכון
              </button>
            </div>
            <div className="rounded-xl border border-white/[0.06] bg-white/[0.03] p-4">
        ...
        <motion.div
          variants={itemVariants}
          className="rounded-2xl border border-amber-200 bg-amber-500/[0.06] backdrop-blur-md p-5"
        >
